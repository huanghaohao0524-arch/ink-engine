...
const checks = [
  ...
  ['legacy runtime keeps saved profiles below settings inputs', enhancer.includes("formGrid.insertAdjacentElement('afterend', row)") && !enhancer.includes('panel.insertBefore(row, presetRow)')],
